(function(){
  ...
  if (location.pathname.endsWith('dashboard.html')){
    ...
    const rawTeam = [
      ...
      { name:'NGUYỄN THỊ HỒNG THẮM', dob:'1999-02-02', mssv:'K23DTCN027', class:'KTPM01', phone:'0902000333', email:'two@example.com', org:'Cong ty XYZ', orgUrl:'https://example.com', avatar:'./assets/team/tham.jpg', task:'FE chính, UI/UX.' },
      ...
      { name:'TRẦN THẾ LINH', dob:'1999-03-03', mssv:'K23DTCN027', class:'CNTT02', phone:'0903000444', email:'three@example.com', org:'Cong ty DEF', orgUrl:'https://example.com',avatar:'./assets/team/linh.jpg', task:'BE chính, dữ liệu.' }
    ];
    const team = rawTeam; 
